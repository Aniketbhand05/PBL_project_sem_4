    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'timestamp':
          ...
          break;
        case 'chats_msg':
          result.chatsMsg = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class _$ChatMessagesRecord extends ChatMessagesRecord {
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, chatsMsg.hashCode);
...
class ChatMessagesRecordBuilder
  ...
  String? _chatsMsg;
  String? get chatsMsg => _$this._chatsMsg;
  set chatsMsg(String? chatsMsg) => _$this._chatsMsg = chatsMsg;
