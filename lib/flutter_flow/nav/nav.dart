      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: AuthenticateSoloAltWidget(),
          ),
        ),
        FFRoute(
          name: 'ChatPage',
        ...
        FFRoute(
          ...
          path: '/fields',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'fields')
              : FieldsWidget(),
        ),
        FFRoute(
          name: 'engineeringfields',
          path: '/engineeringfields',
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: EngineeringfieldsWidget(),
          ),
        ),
        FFRoute(
          name: 'year',
